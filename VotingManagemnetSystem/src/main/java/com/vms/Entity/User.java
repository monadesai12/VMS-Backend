...
public class User implements Serializable {
	...
	public User(Long id,
			...
			@Pattern(regexp = "\\d{1,10}$", message = "Mobile number is invalid") String mobileNumber, String gender,
			@Pattern(regexp = "^[2-9]{1}[0-9]{3}[0-9]{4}[0-9]{4}$", message = "Aadhar card Number should be valid 12 digit Numer") String adharCardNumber,
			String address, String pincode, @Email(message = "Email is not in valid format") String email,
			String username, String password, LocalDateTime registerAt, LocalDateTime userDeletedAt,
			String deleteUserFlag, String role) {
		super();
		this.id = id;
		this.firstName = firstName;
		this.lastName = lastName;
